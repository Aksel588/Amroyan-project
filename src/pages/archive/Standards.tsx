...
const Standards = () => {
  ...
  useEffect(() => {
    document.title = `${t('archive.subpages.standardsTitle')} | ${t('archive.heroTitle')}`;
  }, [t]);
    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-900 to-black pt-32 px-4 pb-20">
      <div className="max-w-5xl mx-auto">
        ...
        <header className="text-center mb-10">
          <h1 className="text-3xl font-bold text-white">{t('archive.subpages.standardsTitle')}</h1>
          <p className="text-gray-300 mt-2 max-w-2xl mx-auto leading-relaxed">{t('archive.subpages.standardsSubtitle')}</p>
        </header>
